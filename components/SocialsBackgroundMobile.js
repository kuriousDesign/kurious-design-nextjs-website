const SocialsBackgroundMobile = () => {
  ...
  return (
    <div className="xl:hidden fixed bottom-0 left-0 h-[50px] w-full overflow-hidden z-10">
      <div className={`absolute left-1/2 transform -translate-x-1/2 top-full -translate-y-[50px] w-[280px] h-[60px] rounded-t-full backdrop-filter backdrop-blur-lg bg-opacity-30 bg-black`}>
